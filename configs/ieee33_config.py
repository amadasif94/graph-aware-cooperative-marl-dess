...
LINE_CURRENT_SECURITY_MARGIN_RHO = 1.20

GLOBAL_LINE_CURRENT_LIMIT_PU = 5.5
...
PHI_COST = 1.0
PHI_VOLTAGE_DEVIATION = 1.0
PHI_CYCLING = 0.05
PHI_SOC_RESERVE = 0.05
...
INFEASIBLE_ACTION_PENALTY = -50.0
