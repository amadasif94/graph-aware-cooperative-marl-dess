"""
Configuration file for the IEEE 69-bus graph-aware cooperative MARL
...
NYISO day-ahead LBMP price data processed into:
    ...
    data/time_series/processed_15min_smartds_ieee69.csv

All bus indices in the implementation use zero-based indexing:
    buses 0 to 68

DESS placement:
    one-based reference buses: [14, 16, 18, 20, 22, 24, 26, 27, 65]
    zero-based code buses:     [13, 15, 17, 19, 21, 23, 25, 26, 64]
...
NETWORK_DIR = DATA_DIR / "network" / "ieee69"
...
PROCESSED_TIME_SERIES_PATH = TIME_SERIES_DIR / "processed_15min_smartds_ieee69.csv"
GRAPH_SEQUENCE_PATH = PROCESSED_DIR / "ieee69_graph_sequence.npz"
...
# A one-step correction, e.g. action ±1.0 -> ±0.80, is treated as minor
