...
BEST_MLP_MODEL = {
    ...
    "model_type": "mlp_no_gnn",
    "checkpoint": "results/models/IEEE33/mlp/run_2.pt",
}
...
def measure_one_episode(env, agent, model_cfg, args, device, checkpoint_path):
        ...
        [
            {
                ...
                "model_type": times_df["model_type"].iloc[0],
...
def parse_args():
    ...
    parser.add_argument(
        "--out_dir",
        type=str,
        default="results/timing/IEEE33_best_mlp",
    )
...
def main():
    ...
    checkpoint_path = resolve_checkpoint(BEST_MLP_MODEL)

    agent = build_agent(
        env=env,
        model_cfg=BEST_MLP_MODEL,
    ...
    print("=" * 72)
    print("IEEE33 MLP computational-efficiency evaluation")
    print("=" * 72)
