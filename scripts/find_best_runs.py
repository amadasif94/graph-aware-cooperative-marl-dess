...
if all_df.empty:
    raise RuntimeError("No evaluation results found under results/csv/eval.")
...
if safe_df.empty:
    print("WARNING: No checkpoints passed the safety filter.")
