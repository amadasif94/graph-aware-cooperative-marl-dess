"""
Evaluate trained graph-aware MADDPG policy under IEEE 69-bus topology
...
Outputs:
    results/topology_generalization/csv_ieee69/<run_name>/step_metrics.csv
    results/topology_generalization/csv_ieee69/<run_name>/episode_summary.csv
    results/topology_generalization/csv_ieee69/<run_name>/aggregate_summary.csv
    results/topology_generalization/figures_ieee69/<run_name>/*.png
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--run_name",
        type=str,
        default="ieee69_tp_generalization_eval",
    )
...
def main():
    """
    Main IEEE69 topology generalization evaluation routine.
    """
    ...
    print("=================================================")
    print("IEEE69 Graph-Aware MADDPG Topology Generalization")
    print("=================================================")
    print("Device:", device)
    ...
    print()
    print("IEEE69 topology generalization evaluation complete.")
