...
TOPOLOGY_CASES = {
    ...
    "TP3": {
        "description": "Single reconfiguration: open 10-11, close tie 9-15.",
        "open_edges": [(9, 10)],
        "close_edges": [(8, 14)],
    },

    "TP4": {
        "description": "Double reconfiguration: open 6-7 and 10-11; close ties 8-21 and 12-22.",
        "open_edges": [
            (5, 6),
            (9, 10),
        ],
    ...
    "TP5": {
        "description": "Double downstream reconfiguration: open 27-28 and 31-32; close ties 25-29 and 18-33.",
        "open_edges": [
            (26, 27),
            (30, 31),
        ],
    ...
    "TP6": {
        "description": "Downstream reconfiguration: open 31-32, close tie 18-33.",
        "open_edges": [(30, 31)],
        "close_edges": [(17, 32)],
    },
