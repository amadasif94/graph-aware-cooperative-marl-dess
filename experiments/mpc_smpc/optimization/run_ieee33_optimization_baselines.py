# ============================================================
# run_ieee33_optimization_baselines.py
# ============================================================
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run IEEE33 MPC/SMPC optimization baselines."
    )
    ...
    parser.add_argument(
        ...
        help="Topology cases to evaluate, e.g. TP1 TP2 TP3 TP4 TP5 TP6 TP7.",
    )
...
def print_runner_header(args, episodes, topologies):
    print("=" * 72)
    print("IEEE33 OPTIMIZATION BASELINE RUNNER")
    print("=" * 72)
