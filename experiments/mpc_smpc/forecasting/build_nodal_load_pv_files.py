...
INPUT_PATH = PROJECT_ROOT / "data" / "time_series" / "processed_15min_smartds.csv"

OUT_DIR = PROJECT_ROOT / "data" / "processed" / "mpc_smpc"
OUT_DIR.mkdir(parents=True, exist_ok=True)

FULL_YEAR_OUT = OUT_DIR / "ieee33_15min_nodal_load_pv_full_year.csv"
TRAIN_OUT = OUT_DIR / "ieee33_15min_nodal_load_pv_train_jan_aug.csv"
...
def main():
    print("===================================================")
    print("BUILD IEEE33 NODAL LOAD/PV FILES")
    print("===================================================")
