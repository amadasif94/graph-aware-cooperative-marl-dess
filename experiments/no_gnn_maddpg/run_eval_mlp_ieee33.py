"""
Evaluate trained no-GNN / MLP MADDPG policy on IEEE 33-bus DESS environment.
"""
...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="mlp_maddpg_eval")
...
def main():
    ...
    print("===================================")
    print("No-GNN / MLP MADDPG IEEE33 Evaluation")
    print("===================================")
    print("Device:", device)
