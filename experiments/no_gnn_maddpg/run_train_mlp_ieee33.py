"""
Training entry point for no-GNN / MLP MADDPG on IEEE 33-bus DESS environment.
...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint_dir",
        type=str,
        default="results/checkpoints/maddpg_ieee33_mlp",
    )
...
def main():
    ...
    print("===================================")
    print("No-GNN / MLP MADDPG Training")
    print("===================================")
