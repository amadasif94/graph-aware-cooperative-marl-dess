...
This environment combines:
    ...
    - IEEE 33-bus static network data,
...
where w_grid, w_local, and w_kpi are defined in configs/ieee33_config.py.
"""
...
class DESSEnv(gym.Env):
    ...
    def __init__(self, config=None, mode="train", seed=None):
        ...
        self.config = copy.deepcopy(IEEE33_CONFIG if config is None else config)
        self.mode = mode
